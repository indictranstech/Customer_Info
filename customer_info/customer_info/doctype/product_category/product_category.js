frappe.ui.form.on("Product Category","validate",function(frm){	
...
frappe.ui.form.on("Product Category", "period", function(frm){
...
frappe.ui.form.on("Product Category", "ratio", function(frm){
...
frappe.ui.form.on("Product Category", "category_name", function(frm){
